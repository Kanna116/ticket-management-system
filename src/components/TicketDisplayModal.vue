  ...
  <div class="modal-screen">
    ...
    <div class="ticket-container">
      ...
      <div class="ticket-right">
        ...
        <div class="ticket-details-extra">
          <h3>Details</h3>
...
.status-options-container:focus {
  border: 0px;
}
.status-options-container option {
  font-size: 12px;
  font-weight: 500;
}
